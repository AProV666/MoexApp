...
import com.pro.moex.parser.ParserPageSizeAndTotal;
...
public class MoexHistoryServiceImpl implements MoexHistoryService {
    ...
    public List<Ticker> getHistory(String ticker) {
        ...
        ParserPageSizeAndTotal parserPageSizeAndTotal = new ParserPageSizeAndTotal();
        parserPageSizeAndTotal.parse(tickerURL);
        int total = parserPageSizeAndTotal.getTotal();
        int pageSize = parserPageSizeAndTotal.getPageSize();
